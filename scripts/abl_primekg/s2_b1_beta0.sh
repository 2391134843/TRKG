...
EXP_ID="primekg_s2_b1_beta0"
DESC="PrimeKG Stage2 B1 | GRPO --grpo-beta 0 (no KL penalty); reuse baseline candidates; epochs=3"
...
mkdir -p "${S2_OUT}"
run_grpo "${S2_OUT}" "${PK_BASELINE_CAND_DIR}"
mark_exp_done
