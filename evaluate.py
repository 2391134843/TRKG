...
def predict_by_split():
    ...
    logger.info('[Test] Averaged metrics: {}'.format(metrics))
...
def eval_single_direction(predictor,
    ...
    logger.info('[Test] predict tensor done, compute metrics...')
    ...
    logger.info('[Test] {} metrics: {}'.format(eval_dir, json.dumps(metrics)))
    ...
    logger.info('[Test] Evaluation takes {} seconds'.format(round(time() - start_time, 3)))
    return metrics
